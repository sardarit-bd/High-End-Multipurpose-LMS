      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-2xl mx-auto">
            {[
              { value: "1,250+", label: t("leaderboard.hero.stats.players"), icon: FaUsers },
              { value: "45", label: t("leaderboard.hero.stats.schools"), icon: FaUniversity },
              { value: "5", label: t("leaderboard.hero.stats.regions"), icon: FaMapMarkerAlt },
              { value: "2.5M+", label: t("leaderboard.hero.stats.points"), icon: FaAward },
            ].map((stat, index) => (
              <div
                key={index}
