...
const EventHerosection = ({eventData,countdown,isLiked,setIsLiked,isBookmarked,setIsBookmarked,handleRegister,shareEvent}) => {
return (
<section className="relative min-h-[100vh] overflow-hidden">
    ...
    <div className="container mx-auto px-4">
        ...
        <div className="text-center lg:text-left">
            ...
            Learn from industry experts and network with professionals from around the world.
            </p>
            ...
            <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-gray-700">
                {eventData.rating} Rating ({eventData.reviews.toLocaleString()}+ reviews)
                </span>
            </div>
            </div>
        </div>
        ...
        <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 to-purple-600 shadow-2xl">
                ...
                <div className="mb-6">
                    ...
                    Learn cutting-edge techniques from industry leaders and take your marketing skills to the next level.
                    </p>
                </div>
            ...
            <div className="absolute -bottom-4 -left-4">
                <div className="animate-bounce rounded-2xl bg-yellow-400 p-3 shadow-lg" style={{ animationDelay: '1s' }}>
