...
const resources = {
  en: {
    translation: {
      ...
      "leaderboard.hero.title": "SDG Rankings",
      "leaderboard.hero.subtitle": "Compete with global changemakers. Track your impact. Lead the sustainable revolution.",
      "leaderboard.hero.stats.players": "Active Players",
      "leaderboard.hero.stats.schools": "Schools",
      "leaderboard.hero.stats.regions": "Regions",
      "leaderboard.hero.stats.points": "Points Earned",

      "rankCard.title": "Your Ranking",
      "rankCard.subtitle": "Keep going! You're making great progress",
      "rankCard.points": "points",

      "filters.title": "Live Rankings",
      "filters.subtitle": "Track performance across different categories and timeframes",
      "filters.refresh": "Refresh",

      "filters.categories.global": "Global Ranking",
      "filters.categories.globalDesc": "Top performers worldwide",
      "filters.categories.school": "School Ranking",
      "filters.categories.schoolDesc": "Leading educational institutions",
      "filters.categories.regional": "Regional Ranking",
      "filters.categories.regionalDesc": "Performance by districts",

      "filters.timeframes.allTime": "All Time",
      "filters.timeframes.monthly": "This Month",
      "filters.timeframes.weekly": "This Week",
      ...
      "leaderboard.schoolRankings": "School Rankings",
      "leaderboard.regionalRankings": "Regional Rankings",
      "leaderboard.playerRankings": "Player Rankings",
      "leaderboard.swipeHint": "Swipe to see more details",

      "infoCard.pointsTitle": "How Points Work",
      "infoCard.quiz": "Complete quizzes:",
      "infoCard.missions": "Finish missions:",
      "infoCard.activities": "Real-world activities:",
      "infoCard.login": "Daily login streak:",
      "infoCard.points": "points",
      "infoCard.pointsPerDay": "points/day",
      "infoCard.rankTitle": "Climb the Ranks",
      "infoCard.description": "Compete with learners worldwide, earn badges for achievements, and track your progress towards becoming an SDG champion. Leaderboards update in real-time!",
      "infoCard.startLearning": "Start Learning",
      "infoCard.viewBadges": "View Badges",

      // Contact us page translations

      "contact.address": "Address",
      "contact.addressDetail": "1364 Still Water Dr, AK 99801.",
      "contact.phone": "Phone",
      "contact.phoneNumber": "+1 (907) 789-7623",
      "contact.email": "Email",
      "contact.emailAddress": "contact@sardarit.com",
      "contact.contactUs": "Contact Us",
      "contact.heading": "Get in touch with us today",
      "contact.description": "Get in touch with us to explore how our LMS solution can enhance your e-learning experience. We’re here to help you build a seamless and engaging learning platform!",
      ...
      "terms.intro": "Please read these Terms and Conditions carefully before using our platform. By accessing or using our services, you agree to be bound by these terms.",
      "terms.updated": "Last updated:",
      "terms.print": "Print",
      "terms.toc": "On this page",
      "terms.version": "Version",
      "terms.versionNote": "These terms apply to all users of the platform. Enterprise contracts may include additional terms.",
      "terms.notice": "By continuing to use the platform, you acknowledge that you have read and agree to these Terms & Conditions.",
      "terms.linkCopied": "Link copied",

      "terms.acceptance.title": "1. Acceptance of Terms",
      "terms.acceptance.text": "By accessing and using this platform, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree with any part of these terms, you may not use our services.",

      "terms.use.title": "2. Use of Services",
      "terms.use.text": "You agree to use the platform only for lawful purposes and in a way that does not infringe the rights of others or restrict their use and enjoyment of the services.",

      "terms.ip.title": "3. Intellectual Property",
      "terms.ip.text": "All content, features, and functionality on this platform are the property of our company and are protected by international laws.",

      "terms.liability.title": "4. Limitation of Liability",
      "terms.liability.text": "We are not liable for any damages that may occur as a result of using our services. Your use of the platform is at your own risk.",

      "terms.changes.title": "5. Changes to Terms",
      "terms.changes.text": "We reserve the right to update or modify these Terms & Conditions at any time without notice. Continued use constitutes acceptance of the updated terms.",

      "terms.contact.title": "6. Contact Us",
      "terms.contact.text": "If you have any questions about these Terms & Conditions, please contact us at support@example.com.",

      // Blog page translations


      "blog.title": "Learn Web App Development from Experts in 2024",
      "blog.author": "John Miller",
      "blog.date": "20 Apr 2024",
      "blog.imageAlt": "Learn Web App Development from Experts in 2024",
      "blog.para1": "Web app development continues to be one of the most sought-after skills in the tech industry...",
      "blog.para2": "Starting in 2024 brings new tools and frameworks like React, Angular, and Vue.js...",
      "blog.quote": "Invest in fundamentals, then iterate fast with modern tooling.",
      "blog.para3": "Now is the time to start learning with expert mentorship and real projects.",
      "blog.focus": "What to focus on",
      "blog.focus1": "Core web: HTML, CSS, JavaScript/TypeScript",
      "blog.focus2": "Frameworks: React, Vue, or Angular",
      "blog.focus3": "Data: REST/GraphQL, caching, fetch patterns",
      "blog.focus4": "Backend basics: Node, Databases, authentication, deployment",
      "blog.focus5": "Tooling: Git, testing, CI/CD, performance",
      "blog.commentTitle": "Leave a Comment",
      "blog.name": "Name",
      "blog.email": "Email",
      "blog.comment": "Comment",
      "blog.save": "Save my name & email for next time",
      "blog.submit": "Submit",
      "blog.share": "Share",
      "blog.tags": "Tags",
      ...
      "blog.categories.technical": "Technical",


      // Game Page Translations
      "games.loadingTitle": "Loading Games",
      "games.loadingText": "Preparing amazing learning experiences...",
      "games.pageTitle": "SDG Games - Interactive Learning Platform",
      "games.pageDesc": "Learn about Sustainable Development Goals through fun and interactive games.",

      "games.data.trivia": "SDG Trivia Challenge",
      "games.data.triviaDesc": "Test your knowledge about Sustainable Development Goals with this fun trivia game.",
      "games.data.climate": "Climate Action Simulator",
      "games.data.climateDesc": "Make strategic decisions to reduce carbon footprint and save the planet.",
      "games.data.water": "Clean Water Puzzle",
      "games.data.waterDesc": "Solve puzzles to provide clean water to communities and learn sustainability concepts.",

      "gameHero.title": "Play & Learn SDGs",
      "gameHero.subtitle": "Discover the 17 Sustainable Development Goals through engaging games, interactive challenges, and immersive learning experiences",
      "gameHero.stats.games": "Interactive Games",
      "gameHero.stats.players": "Active Learners",
      "gameHero.stats.rating": "Average Rating",
      "gameHero.stats.hours": "Learning Hours",

      "gameFilter.title": "Explore Games",
      "gameFilter.subtitle": "Filter by SDG goals, search by title, or browse by game type",
      "gameFilter.refresh": "Refresh",
      "gameFilter.searchPlaceholder": "Search games...",
      "gameFilter.sdgLabel": "SDG Goal:",
      "gameFilter.typeLabel": "Game Type:",
      "gameFilter.type.all": "All",
      "gameFilter.type.embed": "Embed",
      "gameFilter.type.external": "External",
      "gameFilter.type.download": "Download",
      "gameFilter.showing": "Showing",
      "gameFilter.of": "of",
      "gameFilter.games": "games",
      "gameFilter.clear": "Clear Filters",

      "gameList.noGamesTitle": "No Games Found",
      "gameList.noGamesDesc": "We couldn't find any games matching your search criteria. Try adjusting your filters or search terms.",
      "gameList.showAllBtn": "Show All Games",

      "gameInfo.title": "Gamified Learning Experience",
      "gameInfo.description": "Our interactive SDG games transform complex global challenges into engaging learning experiences. Each game is carefully designed to promote critical thinking, problem-solving, and awareness about the 17 Sustainable Development Goals through immersive gameplay and real-world scenarios.",
      "gameInfo.point1.title": "Interactive Learning",
      "gameInfo.point1.subtitle": "Hands-on experience",
      "gameInfo.point2.title": "Multiple Formats",
      "gameInfo.point2.subtitle": "Play online or download",
      "gameInfo.point3.title": "Progress Tracking",
      "gameInfo.point3.subtitle": "Monitor learning journey",

      "gameCard.playNow": "Play Now",
      "gameCard.playOnline": "Play Online",
      "gameCard.downloadGame": "Download Game",
      "gameCard.type.embed": "Embedded",
      "gameCard.type.external": "Online",
      "gameCard.type.download": "Download",
      "gameCard.goal": "Goal",

      "games.triviaTitle": "SDG Trivia Challenge",
      "games.triviaDesc": "Test your knowledge about Sustainable Development Goals with this fun trivia game. Answer questions and learn interesting facts about global development.",

      "games.climateTitle": "Climate Action Simulator",
      "games.climateDesc": "Make strategic decisions to reduce carbon footprint and save the planet. Manage resources and implement eco-friendly policies.",

      "games.waterTitle": "Clean Water Puzzle",
      "games.waterDesc": "Solve challenging puzzles to provide clean water to communities. Build water filtration systems and manage distribution networks.",

      "games.genderTitle": "Gender Equality Quiz",
      "games.genderDesc": "Learn about gender equality through interactive quizzes and scenarios. Understand challenges and solutions for gender parity.",

      "games.cityTitle": "Sustainable Cities Game",
      "games.cityDesc": "Build sustainable cities while managing resources and infrastructure. Balance economic growth with environmental protection.",

      "games.oceanTitle": "Life Below Water Adventure",
      "games.oceanDesc": "Explore marine life and protect ocean ecosystems. Complete missions to clean oceans and preserve marine biodiversity.",

      "games.hungerTitle": "Zero Hunger Strategy",
      "games.hungerDesc": "Develop strategies to combat hunger and improve food security. Manage agricultural systems and distribution networks.",

      "games.energyTitle": "Renewable Energy Tycoon",
      "games.energyDesc": "Build and manage renewable energy infrastructure. Invest in solar, wind, and hydro power to create sustainable energy grids.",


      "sponsor.heroTitle": "Partner With Purpose",
      "sponsor.heroDesc": "Join forces to create sustainable impact. Choose from tailored sponsorship packages designed for maximum value and social return.",
      "sponsor.partners": "Partners",
      "sponsor.impact": "Impact Generated",
      "sponsor.goals": "SDG Goals",
      "sponsor.projects": "Projects",

      "sponsor.partnershipTitle": "Partnership Opportunities",
      "sponsor.partnershipSubtitle": "Discover the perfect partnership model for your organization",

      "sponsor.pageTitle": "Partnership Opportunities - Sponsor SDG Initiatives",
      "sponsor.pageDesc": "Explore corporate sponsorship packages and partnership opportunities for Sustainable Development Goals",

      "sponsor.corporateTitle": "Corporate Sponsorships",
      "sponsor.corporateDesc": "Strategic partnerships with businesses and corporations",
      "sponsor.corporateFeature1": "Brand visibility",
      "sponsor.corporateFeature2": "Employee engagement",
      "sponsor.corporateFeature3": "CSR initiatives",
      "sponsor.corporateFeature4": "Networking opportunities",

      "sponsor.institutionalTitle": "Institutional Partnerships",
      "sponsor.institutionalDesc": "Collaborations with educational and research institutions",
      "sponsor.institutionalFeature1": "Research collaboration",
      "sponsor.institutionalFeature2": "Student programs",
      "sponsor.institutionalFeature3": "Knowledge sharing",
      "sponsor.institutionalFeature4": "Academic partnerships",

      "sponsor.communityTitle": "Community Partners",
      "sponsor.communityDesc": "Engagement with local communities and organizations",
      "sponsor.communityFeature1": "Local impact",
      "sponsor.communityFeature2": "Community outreach",
      "sponsor.communityFeature3": "Grassroots initiatives",
      "sponsor.communityFeature4": "Social development",

      "sponsor.bronzeName": "Bronze",
      "sponsor.bronzeBadge": "Starter",
      "sponsor.bronzeFeature1": "Logo on website",
      "sponsor.bronzeFeature2": "Social media mention",
      "sponsor.bronzeFeature3": "Event program listing",
      "sponsor.bronzeFeature4": "Quarterly newsletter feature",
      "sponsor.bronzeBenefit1": "Basic brand visibility",
      "sponsor.bronzeBenefit2": "Digital recognition",
      "sponsor.bronzeBenefit3": "Community engagement",

      "sponsor.silverName": "Silver",
      "sponsor.silverBadge": "Growth",
      "sponsor.silverFeature1": "All Bronze benefits",
      "sponsor.silverFeature2": "Featured blog post",
      "sponsor.silverFeature3": "Event booth space",
      "sponsor.silverFeature4": "Press release inclusion",
      "sponsor.silverFeature5": "Newsletter dedicated section",
      "sponsor.silverBenefit1": "Enhanced visibility",
      "sponsor.silverBenefit2": "Content marketing",
      "sponsor.silverBenefit3": "Direct audience access",

      "sponsor.goldName": "Gold",
      "sponsor.goldBadge": "Popular",
      "sponsor.goldFeature1": "All Silver benefits",
      "sponsor.goldFeature2": "Keynote speaking opportunity",
      "sponsor.goldFeature3": "Premium logo placement",
      "sponsor.goldFeature4": "Dedicated social media campaign",
      "sponsor.goldFeature5": "VIP event invitations",
      "sponsor.goldFeature6": "Annual impact report",
      "sponsor.goldBenefit1": "Thought leadership",
      "sponsor.goldBenefit2": "Premium positioning",
      "sponsor.goldBenefit3": "Exclusive networking",

      "sponsor.platinumName": "Platinum",
      "sponsor.platinumBadge": "Elite",
      "sponsor.platinumFeature1": "All Gold benefits",
      "sponsor.platinumFeature2": "Title sponsorship rights",
      "sponsor.platinumFeature3": "Exclusive workshop hosting",
      "sponsor.platinumFeature4": "Customized partnership program",
      "sponsor.platinumFeature5": "Executive advisory role",
      "sponsor.platinumFeature6": "Media coverage guarantee",
      "sponsor.platinumFeature7": "Dedicated account manager",
      "sponsor.platinumBenefit1": "Industry leadership",
      "sponsor.platinumBenefit2": "Maximum exposure",
      "sponsor.platinumBenefit3": "Strategic influence",

      "sponsor.packagesTitle": "Sponsorship Packages",
      "sponsor.packagesSubtitle": "Choose the package that best aligns with your organization's goals and budget",
      "sponsor.mostPopular": "MOST POPULAR",
      "sponsor.keyFeatures": "Key Features",
      "sponsor.keyBenefits": "Key Benefits",
      "sponsor.selectPackage": "Select Package",
      "sponsor.packageDetails": "Package Details",
      "sponsor.packageOverview": "Complete overview of benefits and implementation process",
      "sponsor.ctaStart": "Start Partnership Discussion",
      "sponsor.ctaSub": "Schedule a personalized consultation to discuss your sponsorship goals",

      "donation.pageTitle": "Support SDG Initiatives - Make a Donation",
      "donation.pageDesc": "Contribute to Sustainable Development Goals projects, student funds, and educational initiatives",

      "donation.sdgTitle": "Support SDG Projects",
      "donation.sdgDesc": "Fund innovative projects that address the 17 Sustainable Development Goals in our community",
      "donation.sdgBadge": "Most Popular",
      "donation.sdgExample1": "Clean water initiatives",
      "donation.sdgExample2": "Renewable energy projects",
      "donation.sdgExample3": "Environmental conservation",
      "donation.sdgExample4": "Community development",
      "donation.sdgImpact": "Supports 3–5 community projects",

      "donation.studentTitle": "Student Fund",
      "donation.studentDesc": "Provide scholarships and financial aid to deserving students pursuing SDG-related studies",
      "donation.studentBadge": "Education Focus",
      "donation.studentExample1": "Tuition fee assistance",
      "donation.studentExample2": "Research grants",
      "donation.studentExample3": "Internship opportunities",
      "donation.studentExample4": "Educational materials",
      "donation.studentImpact": "Supports 2–3 students annually",

      "donation.eduTitle": "Edufest Impact Fund",
      "donation.eduDesc": "Support our annual education festival that promotes SDG awareness and youth engagement",
      "donation.eduBadge": "Event Support",
      "donation.eduExample1": "Event organization",
      "donation.eduExample2": "Speaker invitations",
      "donation.eduExample3": "Workshop materials",
      "donation.eduExample4": "Youth participation support",
      "donation.eduImpact": "Reaches 500+ participants",

      "donation.alertSelectAmount": "Please select or enter a donation amount",
      "donation.redirectMessage": "Redirecting to payment gateway with amount: ${{amount}}",
      "donation.errorMessage": "Error processing donation. Please try again.",

      "donationHeader.title": "Make an Impact",
      "donationHeader.subtitle": "Your generosity fuels sustainable change. Choose your cause and create lasting impact today.",
      "donationHeader.totalImpact": "Total Impact",
      "donationHeader.changemakers": "Changemakers",
      "donationHeader.sdgGoals": "SDG Goals",

      "fundSidebar.title": "Choose Your Cause"
  ...
  ms: {
    translation: {
      ...
      // leaderboard page Malay translations
      "leaderboard.hero.title": "Kedudukan SDG",
      "leaderboard.hero.subtitle": "Bersaing dengan pencipta perubahan global. Jejaki impak anda. Pimpin revolusi lestari.",
      "leaderboard.hero.stats.players": "Pemain Aktif",
      "leaderboard.hero.stats.schools": "Sekolah",
      "leaderboard.hero.stats.regions": "Wilayah",
      "leaderboard.hero.stats.points": "Mata Diperoleh",

      "rankCard.title": "Kedudukan Anda",
      "rankCard.subtitle": "Teruskan! Anda sedang membuat kemajuan yang hebat",
      "rankCard.points": "mata",
      

      "filters.title": "Kedudukan Langsung",
      "filters.subtitle": "Jejaki prestasi merentasi kategori dan jangka masa yang berbeza",
      "filters.refresh": "Segarkan",

      "filters.categories.global": "Kedudukan Global",
      "filters.categories.globalDesc": "Prestasi terbaik di seluruh dunia",
      "filters.categories.school": "Kedudukan Sekolah",
      "filters.categories.schoolDesc": "Institusi pendidikan terkemuka",
      "filters.categories.regional": "Kedudukan Wilayah",
      "filters.categories.regionalDesc": "Prestasi mengikut daerah",

      "filters.timeframes.allTime": "Sepanjang Masa",
      "filters.timeframes.monthly": "Bulan Ini",
      "filters.timeframes.weekly": "Minggu Ini",


      "leaderboard.rank": "Kedudukan",
      "leaderboard.player": "Pemain",
      "leaderboard.points": "Mata",
      "leaderboard.school": "Sekolah",
      "leaderboard.region": "Wilayah",
      "leaderboard.students": "Pelajar",
      "leaderboard.schools": "Sekolah",
      "leaderboard.badges": "Lencana",
      "leaderboard.progress": "Kemajuan",
      "leaderboard.participants": "Peserta",
      "leaderboard.schoolRankings": "Kedudukan Sekolah",
      "leaderboard.regionalRankings": "Kedudukan Wilayah",
      "leaderboard.playerRankings": "Kedudukan Pemain",
      "leaderboard.swipeHint": "Leret untuk melihat lebih banyak butiran",

      "infoCard.pointsTitle": "Bagaimana Mata Berfungsi",
      "infoCard.quiz": "Lengkapkan kuiz:",
      "infoCard.missions": "Selesaikan misi:",
      "infoCard.activities": "Aktiviti dunia sebenar:",
      "infoCard.login": "Siri log masuk harian:",
      "infoCard.points": "mata",
      "infoCard.pointsPerDay": "mata/hari",
      "infoCard.rankTitle": "Naik Kedudukan",
      "infoCard.description": "Bersaing dengan pelajar di seluruh dunia, peroleh lencana untuk pencapaian, dan jejak kemajuan anda untuk menjadi juara SDG. Papan kedudukan dikemas kini secara masa nyata!",
      "infoCard.startLearning": "Mulakan Pembelajaran",
      "infoCard.viewBadges": "Lihat Lencana",
      ...
      "contact.heading": "Hubungi kami hari ini",
      "contact.description": "Hubungi kami untuk meneroka bagaimana penyelesaian LMS kami dapat meningkatkan pengalaman e-pembelajaran anda. Kami di sini untuk membantu anda membina platform pembelajaran yang lancar dan menarik!",
      ...
      "terms.legal": "Perundangan & Pematuhan",
      "terms.title": "Terma & Syarat",
      "terms.intro": "Sila baca Terma dan Syarat ini dengan teliti sebelum menggunakan platform kami. Dengan mengakses atau menggunakan perkhidmatan kami, anda bersetuju untuk terikat dengan terma ini.",
      "terms.updated": "Kemas kini terakhir:",
      "terms.print": "Cetak",
      "terms.toc": "Di halaman ini",
      "terms.version": "Versi",
      "terms.versionNote": "Terma ini terpakai kepada semua pengguna platform. Kontrak perusahaan mungkin termasuk terma tambahan.",
      "terms.notice": "Dengan terus menggunakan platform ini, anda mengakui bahawa anda telah membaca dan bersetuju dengan Terma & Syarat ini.",
      "terms.linkCopied": "Pautan disalin",

      "terms.acceptance.title": "1. Penerimaan Terma",
      "terms.acceptance.text": "Dengan mengakses dan menggunakan platform ini, anda bersetuju untuk terikat dengan peruntukan perjanjian ini. Jika anda tidak bersetuju, sila hentikan penggunaan perkhidmatan kami.",

      "terms.use.title": "2. Penggunaan Perkhidmatan",
      "terms.use.text": "Anda bersetuju untuk menggunakan platform ini hanya untuk tujuan yang sah dan tidak melanggar hak pengguna lain.",

      "terms.ip.title": "3. Harta Intelek",
      "terms.ip.text": "Semua kandungan, ciri dan fungsi dalam platform ini adalah milik syarikat kami dan dilindungi oleh undang-undang antarabangsa.",

      "terms.liability.title": "4. Had Tanggungjawab",
      "terms.liability.text": "Kami tidak bertanggungjawab atas sebarang kerosakan akibat penggunaan perkhidmatan kami. Penggunaan anda adalah atas risiko sendiri.",

      "terms.changes.title": "5. Perubahan Terma",
      "terms.changes.text": "Kami berhak untuk mengemas kini atau mengubah Terma & Syarat ini pada bila-bila masa tanpa notis terlebih dahulu. Penggunaan berterusan dianggap sebagai penerimaan terma yang dikemas kini.",

      "terms.contact.title": "6. Hubungi Kami",
      "terms.contact.text": "Jika anda mempunyai sebarang soalan mengenai Terma & Syarat ini, sila hubungi kami di support@example.com.",

      // Blog Page Translations

      "blog.title": "Belajar Pembangunan Aplikasi Web daripada Pakar pada 2024",
      "blog.author": "John Miller",
      "blog.date": "20 Apr 2024",
      "blog.imageAlt": "Belajar Pembangunan Aplikasi Web daripada Pakar pada 2024",
      "blog.para1": "Pembangunan aplikasi web terus menjadi kemahiran yang paling dicari dalam industri teknologi...",
      "blog.para2": "Mulakan pada tahun 2024 dengan alat dan kerangka kerja moden seperti React, Angular dan Vue.js...",
      "blog.quote": "Labur dalam asas, kemudian tingkatkan dengan alat moden.",
      "blog.para3": "Sekarang masa terbaik untuk belajar dengan bimbingan pakar dan projek sebenar.",
      "blog.focus": "Perkara untuk difokuskan",
      "blog.focus1": "Web asas: HTML, CSS, JavaScript/TypeScript",
      "blog.focus2": "Kerangka: React, Vue, atau Angular",
      "blog.focus3": "Data: REST/GraphQL, caching, corak fetch",
      "blog.focus4": "Asas backend: Node, pangkalan data, pengesahan, deployment",
      "blog.focus5": "Alat: Git, ujian, CI/CD, prestasi",
      "blog.commentTitle": "Tinggalkan Komen",
      "blog.name": "Nama",
      "blog.email": "E-mel",
      "blog.comment": "Komen",
      "blog.save": "Simpan nama & e-mel saya untuk kali seterusnya",
      "blog.submit": "Hantar",
      "blog.share": "Kongsi",
      "blog.tags": "Tag",
      "blog.recent": "Catatan Terkini",
      "blog.linkCopied": "Pautan disalin!",

      "blog.searchPlaceholder": "Cari artikel...",
      "blog.noResults": "Tiada artikel ditemui yang sepadan dengan carian anda.",
      "blog.pagination.prev": "Sebelum",
      "blog.pagination.next": "Seterusnya",
      "blog.categories.education": "Pendidikan",
      "blog.categories.guides": "Panduan",
      "blog.categories.technical": "Teknikal",

      // Game page translations

      "games.loadingTitle": "Memuatkan Permainan",
      "games.loadingText": "Menyediakan pengalaman pembelajaran yang menakjubkan...",
      "games.pageTitle": "Permainan SDG - Platform Pembelajaran Interaktif",
      "games.pageDesc": "Pelajari Matlamat Pembangunan Lestari melalui permainan yang menyeronokkan dan interaktif.",

      "games.data.trivia": "Cabaran Kuiz SDG",
      "games.data.triviaDesc": "Uji pengetahuan anda tentang Matlamat Pembangunan Lestari melalui kuiz yang menyeronokkan.",
      "games.data.climate": "Simulator Tindakan Iklim",
      "games.data.climateDesc": "Buat keputusan strategik untuk mengurangkan jejak karbon dan menyelamatkan planet ini.",
      "games.data.water": "Teka-teki Air Bersih",
      "games.data.waterDesc": "Selesaikan teka-teki untuk membekalkan air bersih kepada komuniti dan fahami konsep kelestarian.",

      "gameHero.title": "Main & Belajar SDG",
      "gameHero.subtitle": "Terokai 17 Matlamat Pembangunan Mampan melalui permainan menarik, cabaran interaktif, dan pengalaman pembelajaran yang mengasyikkan",
      "gameHero.stats.games": "Permainan Interaktif",
      "gameHero.stats.players": "Pelajar Aktif",
      "gameHero.stats.rating": "Penilaian Purata",
      "gameHero.stats.hours": "Jam Pembelajaran",

      "gameFilter.title": "Teroka Permainan",
      "gameFilter.subtitle": "Tapis mengikut matlamat SDG, cari mengikut tajuk, atau semak jenis permainan",
      "gameFilter.refresh": "Segar Semula",
      "gameFilter.searchPlaceholder": "Cari permainan...",
      "gameFilter.sdgLabel": "Matlamat SDG:",
      "gameFilter.typeLabel": "Jenis Permainan:",
      "gameFilter.type.all": "Semua",
      "gameFilter.type.embed": "Terbenam",
      "gameFilter.type.external": "Luar",
      "gameFilter.type.download": "Muat Turun",
      "gameFilter.showing": "Menunjukkan",
      "gameFilter.of": "daripada",
      "gameFilter.games": "permainan",
      "gameFilter.clear": "Padam Penapis",

      "gameList.noGamesTitle": "Tiada Permainan Ditemui",
      "gameList.noGamesDesc": "Kami tidak dapat menemui sebarang permainan yang sepadan dengan carian anda. Cuba ubah penapis atau istilah carian anda.",
      "gameList.showAllBtn": "Tunjukkan Semua Permainan",

      "gameInfo.title": "Pengalaman Pembelajaran Bermain",
      "gameInfo.description": "Permainan SDG interaktif kami mengubah cabaran global yang kompleks menjadi pengalaman pembelajaran yang menarik. Setiap permainan direka dengan teliti untuk menggalakkan pemikiran kritikal, penyelesaian masalah, dan kesedaran tentang 17 Matlamat Pembangunan Mampan melalui permainan mendalam dan senario dunia sebenar.",
      "gameInfo.point1.title": "Pembelajaran Interaktif",
      "gameInfo.point1.subtitle": "Pengalaman praktikal",
      "gameInfo.point2.title": "Pelbagai Format",
      "gameInfo.point2.subtitle": "Main dalam talian atau muat turun",
      "gameInfo.point3.title": "Penjejakan Kemajuan",
      "gameInfo.point3.subtitle": "Pantau perjalanan pembelajaran",

      "gameCard.playNow": "Main Sekarang",
      "gameCard.playOnline": "Main Dalam Talian",
      "gameCard.downloadGame": "Muat Turun Permainan",
      "gameCard.type.embed": "Terbenam",
      "gameCard.type.external": "Dalam Talian",
      "gameCard.type.download": "Muat Turun",
      "gameCard.goal": "Matlamat",


      "games.triviaTitle": "Cabaran Trivia SDG",
      "games.triviaDesc": "Uji pengetahuan anda tentang Matlamat Pembangunan Mampan dengan permainan trivia yang menyeronokkan ini. Jawab soalan dan pelajari fakta menarik tentang pembangunan global.",

      "games.climateTitle": "Simulator Tindakan Iklim",
      "games.climateDesc": "Buat keputusan strategik untuk mengurangkan jejak karbon dan selamatkan planet ini. Urus sumber dan laksanakan dasar mesra alam.",

      "games.waterTitle": "Teka-teki Air Bersih",
      "games.waterDesc": "Selesaikan teka-teki yang mencabar untuk menyediakan air bersih kepada komuniti. Bina sistem penapisan air dan urus pengagihan dengan cekap.",

      "games.genderTitle": "Kuiz Kesaksamaan Gender",
      "games.genderDesc": "Pelajari tentang kesaksamaan gender melalui kuiz dan senario interaktif. Fahami cabaran dan penyelesaian untuk mencapai kesamarataan gender.",

      "games.cityTitle": "Permainan Bandar Mampan",
      "games.cityDesc": "Bina bandar mampan sambil mengurus sumber dan infrastruktur. Seimbangkan pertumbuhan ekonomi dengan perlindungan alam sekitar.",

      "games.oceanTitle": "Pengembaraan Hidupan Laut",
      "games.oceanDesc": "Terokai kehidupan marin dan lindungi ekosistem lautan. Lengkapkan misi untuk membersihkan lautan dan memelihara biodiversiti.",

      "games.hungerTitle": "Strategi Sifar Kelaparan",
      "games.hungerDesc": "Bangunkan strategi untuk memerangi kelaparan dan meningkatkan keselamatan makanan. Urus sistem pertanian dan rangkaian pengedaran.",

      "games.energyTitle": "Taikun Tenaga Boleh Diperbaharui",
      "games.energyDesc": "Bina dan urus infrastruktur tenaga boleh diperbaharui. Melabur dalam tenaga solar, angin, dan hidro untuk mencipta grid tenaga mampan.",
     

      // sponsor page translations
      "sponsor.heroTitle": "Rakan Kongsi Dengan Tujuan",
      "sponsor.heroDesc": "Bersatu tenaga untuk mencipta impak yang mampan. Pilih daripada pakej penajaan yang direka khas untuk nilai maksimum dan pulangan sosial.",
      "sponsor.partners": "Rakan Kongsi",
      "sponsor.impact": "Impak Dihasilkan",
      "sponsor.goals": "Matlamat SDG",
      "sponsor.projects": "Projek",


      "sponsor.partnershipTitle": "Peluang Perkongsian",
      "sponsor.partnershipSubtitle": "Temui model perkongsian yang sempurna untuk organisasi anda",



      "sponsor.pageTitle": "Peluang Perkongsian - Taja Inisiatif SDG",
      "sponsor.pageDesc": "Terokai pakej penajaan korporat dan peluang perkongsian untuk Matlamat Pembangunan Lestari",

      "sponsor.corporateTitle": "Penajaan Korporat",
      "sponsor.corporateDesc": "Perkongsian strategik dengan perniagaan dan korporat",
      "sponsor.corporateFeature1": "Keterlihatan jenama",
      "sponsor.corporateFeature2": "Penglibatan pekerja",
      "sponsor.corporateFeature3": "Inisiatif CSR",
      "sponsor.corporateFeature4": "Peluang rangkaian",

      "sponsor.institutionalTitle": "Perkongsian Institusi",
      "sponsor.institutionalDesc": "Kerjasama dengan institusi pendidikan dan penyelidikan",
      "sponsor.institutionalFeature1": "Kerjasama penyelidikan",
      "sponsor.institutionalFeature2": "Program pelajar",
      "sponsor.institutionalFeature3": "Perkongsian ilmu",
      "sponsor.institutionalFeature4": "Perkongsian akademik",

      "sponsor.communityTitle": "Rakan Komuniti",
      "sponsor.communityDesc": "Penglibatan dengan komuniti dan organisasi tempatan",
      "sponsor.communityFeature1": "Impak tempatan",
      "sponsor.communityFeature2": "Jangkauan komuniti",
      "sponsor.communityFeature3": "Inisiatif akar umbi",
      "sponsor.communityFeature4": "Pembangunan sosial",

      "sponsor.bronzeName": "Gangsa",
      "sponsor.bronzeBadge": "Permulaan",
      "sponsor.bronzeFeature1": "Logo di laman web",
      "sponsor.bronzeFeature2": "Sebutan di media sosial",
      "sponsor.bronzeFeature3": "Senarai program acara",
      "sponsor.bronzeFeature4": "Sorotan dalam buletin suku tahunan",
      "sponsor.bronzeBenefit1": "Keterlihatan asas jenama",
      "sponsor.bronzeBenefit2": "Pengiktirafan digital",
      "sponsor.bronzeBenefit3": "Penglibatan komuniti",

      "sponsor.silverName": "Perak",
      "sponsor.silverBadge": "Pertumbuhan",
      "sponsor.silverFeature1": "Semua faedah Gangsa",
      "sponsor.silverFeature2": "Catatan blog khas",
      "sponsor.silverFeature3": "Ruang reruai acara",
      "sponsor.silverFeature4": "Penyertaan dalam siaran akhbar",
      "sponsor.silverFeature5": "Bahagian khas dalam buletin",
      "sponsor.silverBenefit1": "Keterlihatan dipertingkatkan",
      "sponsor.silverBenefit2": "Pemasaran kandungan",
      "sponsor.silverBenefit3": "Akses terus kepada khalayak",

      "sponsor.goldName": "Emas",
      "sponsor.goldBadge": "Popular",
      "sponsor.goldFeature1": "Semua faedah Perak",
      "sponsor.goldFeature2": "Peluang berucap utama",
      "sponsor.goldFeature3": "Penempatan logo premium",
      "sponsor.goldFeature4": "Kempen media sosial khas",
      "sponsor.goldFeature5": "Jemputan acara VIP",
      "sponsor.goldFeature6": "Laporan impak tahunan",
      "sponsor.goldBenefit1": "Kepimpinan pemikiran",
      "sponsor.goldBenefit2": "Kedudukan premium",
      "sponsor.goldBenefit3": "Rangkaian eksklusif",

      "sponsor.platinumName": "Platinum",
      "sponsor.platinumBadge": "Elit",
      "sponsor.platinumFeature1": "Semua faedah Emas",
      "sponsor.platinumFeature2": "Hak penajaan utama",
      "sponsor.platinumFeature3": "Penganjuran bengkel eksklusif",
      "sponsor.platinumFeature4": "Program perkongsian tersuai",
      "sponsor.platinumFeature5": "Peranan penasihat eksekutif",
      "sponsor.platinumFeature6": "Jaminan liputan media",
      "sponsor.platinumFeature7": "Pengurus akaun khusus",
      "sponsor.platinumBenefit1": "Kepimpinan industri",
      "sponsor.platinumBenefit2": "Pendedahan maksimum",
      "sponsor.platinumBenefit3": "Pengaruh strategik",

      "sponsor.packagesTitle": "Pakej Penajaan",
      "sponsor.packagesSubtitle": "Pilih pakej yang paling sesuai dengan matlamat dan bajet organisasi anda",
      "sponsor.mostPopular": "PALING POPULAR",
      "sponsor.keyFeatures": "Ciri Utama",
      "sponsor.keyBenefits": "Faedah Utama",
      "sponsor.selectPackage": "Pilih Pakej",
      "sponsor.packageDetails": "Butiran Pakej",
      "sponsor.packageOverview": "Gambaran keseluruhan faedah dan proses pelaksanaan",
      "sponsor.ctaStart": "Mulakan Perbincangan Perkongsian",
      "sponsor.ctaSub": "Jadualkan rundingan peribadi untuk membincangkan matlamat penajaan anda",

      // Donation Page Translations

      "donation.pageTitle": "Sokong Inisiatif SDG - Buat Derma",
      "donation.pageDesc": "Sumbangkan kepada projek Matlamat Pembangunan Lestari, tab pelajar, dan inisiatif pendidikan",

      "donation.sdgTitle": "Sokong Projek SDG",
      "donation.sdgDesc": "Biayai projek inovatif yang menangani 17 Matlamat Pembangunan Lestari dalam komuniti kita",
      "donation.sdgBadge": "Paling Popular",
      "donation.sdgExample1": "Inisiatif air bersih",
      "donation.sdgExample2": "Projek tenaga boleh baharu",
      "donation.sdgExample3": "Pemuliharaan alam sekitar",
      "donation.sdgExample4": "Pembangunan komuniti",
      "donation.sdgImpact": "Menyokong 3–5 projek komuniti",

      "donation.studentTitle": "Dana Pelajar",
      "donation.studentDesc": "Sediakan biasiswa dan bantuan kewangan kepada pelajar yang layak dalam bidang berkaitan SDG",
      "donation.studentBadge": "Fokus Pendidikan",
      "donation.studentExample1": "Bantuan yuran pengajian",
      "donation.studentExample2": "Geran penyelidikan",
      "donation.studentExample3": "Peluang latihan industri",
      "donation.studentExample4": "Bahan pendidikan",
      "donation.studentImpact": "Menyokong 2–3 pelajar setiap tahun",

      "donation.eduTitle": "Dana Impak Edufest",
      "donation.eduDesc": "Sokong festival pendidikan tahunan kami yang mempromosikan kesedaran SDG dan penglibatan belia",
      "donation.eduBadge": "Sokongan Acara",
      "donation.eduExample1": "Penganjuran acara",
      "donation.eduExample2": "Jemputan penceramah",
      "donation.eduExample3": "Bahan bengkel",
      "donation.eduExample4": "Sokongan penyertaan belia",
      "donation.eduImpact": "Menjangkau lebih 500 peserta",

      "donation.alertSelectAmount": "Sila pilih atau masukkan jumlah derma",
      "donation.redirectMessage": "Mengalihkan ke gerbang pembayaran dengan jumlah: ${{amount}}",
      "donation.errorMessage": "Ralat memproses derma. Sila cuba lagi.",

      "donationHeader.title": "Beri Impak",
      "donationHeader.subtitle": "Sumbangan anda memacu perubahan mampan. Pilih sebab anda dan cipta impak yang berkekalan hari ini.",
      "donationHeader.totalImpact": "Jumlah Impak",
      "donationHeader.changemakers": "Pencetus Perubahan",
      "donationHeader.sdgGoals": "Matlamat SDG",
      
      "fundSidebar.title": "Pilih Sebab Anda",
