...
const Leaderboard = () => {
  ...
  const mockLeaderboardData = {
    global: [
      ...
      },
      {
        ...
        name: "SustainableSam",
        points: 11200,
        school: "Eco Future School",
        region: "East District",
        badges: ["bronze", "creative"],
    ...
    school: [
      ...
      },
      {
        ...
        region: "South District",
        badges: ["silver"],
        avatar: "/schools/2.jpg",
      },
      {
        id: 3,
        rank: 3,
        name: "Eco Future School",
        points: 26700,
        students: 32,
        region: "East District",
        badges: ["bronze"],
        avatar: "/schools/3.jpg",
      },
      {
        id: 4,
        rank: 4,
  ...
  const categories = [
    {
      id: "global",
      name: "filters.categories.global",
      description: "filters.categories.globalDesc",
      icon: FaGlobe,
    },
    {
      id: "school",
      name: "filters.categories.school",
      description: "filters.categories.schoolDesc",
      icon: FaUniversity,
    },
    {
      id: "regional",
      name: "filters.categories.regional",
      description: "filters.categories.regionalDesc",
      icon: FaMapMarkerAlt,
    },
  ];

  const timeframes = [
    { id: "all-time", name: "filters.timeframes.allTime", icon: FaTrophy },
    { id: "monthly", name: "filters.timeframes.monthly", icon: FaCalendarAlt },
    { id: "weekly", name: "filters.timeframes.weekly", icon: FaFire },
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-green-50">
        <Head>
          ...
          <meta
            name="description"
            content="Track your progress and compete with others in SDG Oasis leaderboard"
          />
        </Head>
